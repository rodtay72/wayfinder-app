...
Write-Host "If you do not have one, sign up free at https://vercel.com" -ForegroundColor White
Write-Host ""
...
Write-Host "Your live URL is shown above." -ForegroundColor White
Write-Host ""
Write-Host "To update the live site after making changes, run:" -ForegroundColor Yellow
