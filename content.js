...
const WAYFINDER_I18N = {
  ...
  "zh-Hans": {
    ...
    "dashboard.childrenHelper": "每个孩子都有一个生成的 Child ID——只有代码，没有姓名。",
    ...
    "relationshipGarden.foot": "这里的成长不代表完美，而是代表关系在被更稳妥地照料和修复。",
    "alignJourney.title": "您的 ALIGN 历程",
    "alignJourney.helper": "温和地看一下，您可能正在通过 ALIGN 练习情绪调节的地方。",
    "alignJourney.regionLabel": "您的 ALIGN 历程",
    "alignJourney.emptyTitle": "您的 ALIGN 历程刚刚开始",
    "alignJourney.emptyBody": "当您解读几个时刻后，Wayfinder 可能会反映需求、CAB 反应、成长练习和下一步行动方面的可能模式。",
    ...
    "decode.start": "开始解读",
    "decode.introLead": "有时孩子的行为，可能是他们尚无法表达的一些东西的可见部分。这不是为了找出孩子哪里不对，而是慢下来，留意他们身上可能发生的事，以及您自己的思维、感受和行动中发生了什么。",
    "decode.realignmentTitle": "为什么重新对齐很重要",
    "decode.realignmentBody": "压力可能会蔓延到关系中。我们在其他地方应对压力、冲突或紧迫感的方式，有时也会跟着我们回家。您的孩子也许还不能像成年人一样梳理强烈的情绪。他们的情绪稳定性可能会强烈影响当下的反应。Wayfinder 帮助您留意，您的思维、感受和行为可能需要在哪里与孩子的经历重新对齐。",
    "decode.begin": "开始",
    ...
    "trail.emotionalPatterns": "您的情绪模式",
    "trail.emotionalPatternsHelper": "在您的反思中出现最多的词语。"
  }
};
