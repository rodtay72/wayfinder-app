...
// Parent-facing static UI copy — PR #124 foundation, PR #125 expansion, PR #126 QA parity, PR #167 expansion.
...
const WAYFINDER_I18N = {
  en: {
    ...
    "common.back": "Back",
    "common.notWrittenYet": "Not written yet",
    "common.notSelectedYet": "Not selected yet",
    "common.saving": "Saving...",
    "common.saveToTrail": "Save to Journal Trail",
    "common.viewTrail": "View Journal Trail",
    "common.returnDashboard": "Return to Dashboard",
    "dashboard.pathwayNote": "Wayfinder helps you reflect on what happened, what your child may have needed, what happened in you, and one next step you may try.",
    "dashboard.plansEntryNote": "Plans are for saving, revisiting, and optional parent-controlled review support. Privacy is included in every plan.",
    "dashboard.shareMhpReview": "Share for MHP review",
    "decode.progressLabel": "Decode a Moment progress",
    "decode.align.A.kicker": "A: Awareness",
    "decode.align.A.title": "Awareness",
    "decode.align.A.heading": "What did you notice?",
    "decode.align.A.sub": "Describe what happened without judging the child.",
    "decode.field.childDid": "What did your child do?",
    "decode.field.when": "When did this happen?",
    "decode.field.firstNotice": "What did you first notice?",
    "decode.continueLocate": "Continue to Locate",
    "decode.align.L.kicker": "L: Locate",
    "decode.align.L.title": "Locate",
    "decode.align.L.heading": "What might this behaviour have been trying to solve for your child?",
    "decode.align.L.sub": "Choose what feels possible. This is a hypothesis, not a diagnosis.",
    "decode.field.possibleNeed": "Possible need underneath the behaviour",
    "decode.field.parentAffect": "What was happening in you at the same time?",
    "decode.continueIntegrate": "Continue to Integrate",
    "decode.align.I.kicker": "I: Integrate",
    "decode.align.I.title": "Integrate",
    "decode.align.I.heading": "What happened in your response?",
    "decode.align.I.sub": "Now connect the child's possible need with your thinking, feelings, and behaviour.",
    "decode.cab.thinking": "My thinking",
    "decode.cab.thinkingLabel": "What thought appeared in your mind?",
    "decode.cab.thinkingHint": "Examples: \"They should know better.\" \"We are going to be late.\" \"This always happens.\" \"I need to stop this now.\" \"I am failing as a parent.\"",
    "decode.cab.feelings": "My feelings",
    "decode.cab.feelingsLabel": "What did you feel emotionally or in your body?",
    "decode.cab.behaviour": "My behaviour / what I did",
    "decode.cab.behaviourLabel": "What did you do next?",
    "decode.continueGrowth": "Continue to Growth",
    "decode.align.G.kicker": "G: Growth",
    "decode.align.G.title": "Growth",
    "decode.align.G.heading": "What capacity might help you meet this need next time?",
    "decode.align.G.sub": "Growth is not about blaming yourself. It is about building alignment capacity.",
    "decode.field.capacity": "Capacity to practise",
    "decode.field.awarenessMarkers": "What are you becoming aware of?",
    "decode.continueNavigate": "Continue to Navigate",
    "decode.align.N.kicker": "N: Navigate",
    "decode.align.N.title": "Navigate",
    "decode.align.N.heading": "What will you try next time?",
    "decode.align.N.sub": "Choose one small next action. Keep it realistic.",
    "decode.field.nextAction": "Possible next action",
    "decode.field.myNextAction": "My next action",
    "decode.field.repair": "Is there anything to repair with your child?",
    "decode.field.observeNext": "What will I observe next time?",
    "decode.showSummary": "Show Summary",
    "decode.summary.kicker": "Reminder",
    "decode.summary.title": "My Alignment Reminder",
    "decode.summary.sub": "Let's explore this as a reflection, not a conclusion.",
    "decode.summary.savedNote": "Saved to your Journal Trail. You can return to this reminder and notice what changes over time.",
    "decode.summary.saveError": "We could not save this reminder yet. Please try again.",
    "decode.summary.reflectionNote": "This is a reflection, not an assessment of your child.",
    "decode.summary.addChildWarning": "Add a child before saving this reminder to Journal Trail.",
    "decode.summary.childConnect": "Which child is this reminder connected to?",
    "decode.summary.connectedChild": "Connected to Child ID:",
    "decode.summary.shareMhp": "Share this reflection for MHP review",
    "decode.summary.label.moment": "The moment I noticed",
    "decode.summary.label.signal": "One possible signal I explored",
    "decode.summary.label.need": "A possible need worth staying curious about",
    "decode.summary.label.inMe": "What was happening in me",
    "decode.summary.label.gap": "Possible alignment gap",
    "decode.summary.label.practise": "What I want to practise",
    "decode.summary.label.next": "My next action",
    "decode.summary.label.repair": "Repair intention",
    "decode.summary.label.observe": "What I will observe next time",
    "decode.summary.thinking": "Thinking:",
    "decode.summary.feelings": "Feelings:",
    "decode.summary.behaviour": "Behaviour / What I did:",
    "plans.title": "Plans",
    "plans.subtitle": "Paid plans help you save, revisit, and reflect on your parent-growth practice. Connect adds optional, parent-controlled MHP review support if you choose it.",
    "plans.privacyBaseline": "Privacy is included in every plan. No ads. No data-selling. Research use is consent-led.",
    "plans.readAccessReassurance": "Reflections you have already saved remain readable even if your trial ends or paid access lapses.",
    "plans.connectDisclaimer": "Wayfinder Connect adds optional, parent-controlled Mental Health Practitioner (MHP) review support. It is not therapy, diagnosis, emergency care, or crisis support.",
    "plans.sandboxTestModeNote": "Upgrades use Stripe secure checkout. Your plan updates after payment is confirmed — it may take a moment to refresh here.",
    "plans.catalogHeading": "Wayfinder plans",
    "plans.currentPlanLabel": "Your current plan",
    "plans.unavailableNote": "Plan details are not ready yet. You can keep using Wayfinder while this is being set up.",
    "plans.checkoutUpgradeMonthly": "Upgrade — monthly",
    "plans.checkoutUpgradeYearly": "Upgrade — yearly",
    "plans.checkoutLoading": "Opening secure checkout…",
    "plans.checkoutDismiss": "Dismiss",
    "plans.manageBillingLabel": "Manage billing",
    "plans.manageBillingLoading": "Opening billing portal…",
    "plans.currentPlanConfirmedNote": "Your current plan reflects what Stripe has confirmed as active now.",
    "plans.monthlyLabel": "Monthly",
    "plans.yearlyLabel": "Yearly",
    "plans.freePriceLabel": "Free",
    "plans.noCardRequired": "No card required",
    "plans.currentPlanBadge": "Current plan",
    "plans.tier.wayfinder.tagline": "30-day trial — start reflecting, no card required.",
    "plans.tier.wayfinder.positioning": "Start reflecting",
    "plans.tier.wayfinder.highlight0": "Core parent reflection pathway",
    "plans.tier.wayfinder.highlight1": "30-day no-card trial",
    "plans.tier.wayfinder.highlight2": "Unlimited reflection saves during your trial",
    "plans.tier.wayfinder.highlight3": "Privacy-first — no ads, no data-selling",
    "plans.tier.wayfinder_plus.tagline": "Unlock unlimited saving and your parent-growth progress tracker.",
    "plans.tier.wayfinder_plus.positioning": "Track your growth",
    "plans.tier.wayfinder_plus.highlight0": "Unlimited reflection saves",
    "plans.tier.wayfinder_plus.highlight1": "Parent-growth progress tracker",
    "plans.tier.wayfinder_plus.highlight2": "Full Journal Trail and practice history",
    "plans.tier.wayfinder_connect.tagline": "Add parent-controlled MHP review support.",
    "plans.tier.wayfinder_connect.positioning": "Add parent-controlled MHP review",
    "plans.tier.wayfinder_connect.highlight0": "Everything in Wayfinder Plus",
    "plans.tier.wayfinder_connect.highlight1": "Parent-controlled sharing only — nothing automatic",
    "plans.tier.wayfinder_connect.highlight2": "Includes 1 MHP review request per month when enabled",
    "appVersion.title": "App Version",
    "appVersion.subtitle": "A parent-facing record of Wayfinder updates, privacy reminders, and planned improvements.",
    "appVersion.releasedHeading": "Recent updates",
    "appVersion.plannedHeading": "Planned",
    "appVersion.reassurance": "These notes help you understand what may have changed and what is coming next. They are not labels, scores, or clinical assessments.",
    "appVersion.workflowNote": "Wayfinder updates this page when parent-facing improvements are released. Future research or data use will always be explained with clear notice, consent, and privacy safeguards.",
    "appVersion.plannedNote": "These items are planned and may change as Wayfinder develops.",
    ...
    "reviewShare.dashboardCardSubtitle": "Choose saved journal or Decode entries to share with your Mental Health Practitioner for time-limited ALIGN/CAB review. You preview exactly what will be shared before giving consent.",
    "reviewShare.dashboardCardButton": "Open sharing",
    "reviewShare.dashboardAction": "Share for MHP review",
    "reviewShare.browseTrail": "View full journal trail",
    "reviewShare.postSaveButton": "Share this reflection for MHP review",
    "reflection.languageHelper": "Write in the language that feels most natural to you. Wayfinder will keep your private reflection exactly as entered.",
    "decode.privacyNudge": "Keep names and identifying details out. Use your child's Child ID or a simple description of what happened."
  },
  "zh-Hans": {
    "language.label": "语言",
    "language.english": "English",
    ...
    "common.saving": "保存中…",
    "common.saveToTrail": "保存到反思记录",
    "common.viewTrail": "查看反思记录",
    "common.returnDashboard": "返回首页",
    "dashboard.pathwayNote": "Wayfinder 帮助您回顾发生了什么、孩子可能有哪些需求、您身上发生了什么，以及您也许可以尝试的一个下一步。",
    "dashboard.plansEntryNote": "方案用于保存、回顾，以及您自愿选择的心理健康从业者（MHP）审阅支持。每个方案都包含隐私保护。",
    "dashboard.shareMhpReview": "分享给 MHP 审阅",
    "decode.progressLabel": "解读一个时刻进度",
    "decode.align.A.kicker": "A：觉察",
    "decode.align.A.title": "觉察",
    "decode.align.A.heading": "您注意到了什么？",
    "decode.align.A.sub": "描述发生了什么，不要评判孩子。",
    "decode.field.childDid": "孩子做了什么？",
    "decode.field.when": "什么时候发生的？",
    "decode.field.firstNotice": "您最先注意到什么？",
    "decode.continueLocate": "继续：定位",
    "decode.align.L.kicker": "L：定位",
    "decode.align.L.title": "定位",
    "decode.align.L.heading": "这个行为也许是在为孩子解决什么？",
    "decode.align.L.sub": "选择您觉得可能的情况。这是假设，不是诊断。",
    "decode.field.possibleNeed": "行为背后可能的需求",
    "decode.field.parentAffect": "同时，您身上发生了什么？",
    "decode.continueIntegrate": "继续：整合",
    "decode.align.I.kicker": "I：整合",
    "decode.align.I.title": "整合",
    "decode.align.I.heading": "您的回应中发生了什么？",
    "decode.align.I.sub": "现在把孩子可能的需求与您的想法、感受和行为联系起来。",
    "decode.cab.thinking": "我的想法",
    "decode.cab.thinkingLabel": "脑海中出现了什么想法？",
    "decode.cab.thinkingHint": "例如：「他们应该更懂事。」「我们要迟到了。」「总是这样。」「我得马上制止。」「我做得不够好。」",
    "decode.cab.feelings": "我的感受",
    "decode.cab.feelingsLabel": "您在情绪或身体上有什么感受？",
    "decode.cab.behaviour": "我的行为 / 我做了什么",
    "decode.cab.behaviourLabel": "接下来您做了什么？",
    "decode.continueGrowth": "继续：成长",
    "decode.align.G.kicker": "G：成长",
    "decode.align.G.title": "成长",
    "decode.align.G.heading": "下次也许需要什么能力来更好地回应这个需求？",
    "decode.align.G.sub": "成长不是责备自己，而是培养重新对齐的能力。",
    "decode.field.capacity": "可以练习的能力",
    "decode.field.awarenessMarkers": "您正在觉察到什么？",
    "decode.continueNavigate": "继续：下一步",
    "decode.align.N.kicker": "N：下一步",
    "decode.align.N.title": "下一步",
    "decode.align.N.heading": "下次您会尝试什么？",
    "decode.align.N.sub": "选择一个小的下一步，保持现实可行。",
    "decode.field.nextAction": "可能的下一步",
    "decode.field.myNextAction": "我的下一步",
    "decode.field.repair": "是否需要与孩子修复关系？",
    "decode.field.observeNext": "下次我会观察什么？",
    "decode.showSummary": "查看总结",
    "decode.summary.kicker": "提醒",
    "decode.summary.title": "我的对齐提醒",
    "decode.summary.sub": "不妨把这份记录当作探索，而不是定论。",
    "decode.summary.savedNote": "已保存到反思记录。您可以随时回来查看，留意随时间的变化。",
    "decode.summary.saveError": "暂时无法保存这份提醒，请稍后再试。",
    "decode.summary.reflectionNote": "这是一份反思，不是对孩子的评估。",
    "decode.summary.addChildWarning": "保存到反思记录前，请先添加孩子。",
    "decode.summary.childConnect": "这份提醒关联哪个孩子？",
    "decode.summary.connectedChild": "已关联 Child ID：",
    "decode.summary.shareMhp": "分享这份反思给 MHP 审阅",
    "decode.summary.label.moment": "我注意到的时刻",
    "decode.summary.label.signal": "我探索的一个可能信号",
    "decode.summary.label.need": "值得继续好奇的可能需求",
    "decode.summary.label.inMe": "在我身上发生了什么",
    "decode.summary.label.gap": "可能的对齐差距",
    "decode.summary.label.practise": "我想练习的",
    "decode.summary.label.next": "我的下一步",
    "decode.summary.label.repair": "修复意向",
    "decode.summary.label.observe": "下次我会观察",
    "decode.summary.thinking": "想法：",
    "decode.summary.feelings": "感受：",
    "decode.summary.behaviour": "行为 / 我做了什么：",
    "plans.title": "方案",
    "plans.subtitle": "付费方案帮助您保存、回顾并练习家长成长。Connect 可在您选择时增加可选的、由家长控制的 MHP 审阅支持。",
    "plans.privacyBaseline": "每个方案都包含隐私保护。无广告。不出售数据。研究用途需经同意。",
    "plans.readAccessReassurance": "即使试用结束或付费访问中断，您已保存的反思仍可阅读。",
    "plans.connectDisclaimer": "Wayfinder Connect 增加可选的、由家长控制的心理健康从业者（MHP）审阅支持。这不是治疗、诊断、紧急护理或危机支持。",
    "plans.sandboxTestModeNote": "升级通过 Stripe 安全结账。付款确认后方案会更新——此处刷新可能需要片刻。",
    "plans.catalogHeading": "Wayfinder 方案",
    "plans.currentPlanLabel": "您当前的方案",
    "plans.unavailableNote": "方案详情尚未就绪。设置完成前您仍可继续使用 Wayfinder。",
    "plans.checkoutUpgradeMonthly": "升级 — 月付",
    "plans.checkoutUpgradeYearly": "升级 — 年付",
    "plans.checkoutLoading": "正在打开安全结账…",
    "plans.checkoutDismiss": "关闭",
    "plans.manageBillingLabel": "管理账单",
    "plans.manageBillingLoading": "正在打开账单门户…",
    "plans.currentPlanConfirmedNote": "您当前的方案反映 Stripe 现已确认的有效方案。",
    "plans.monthlyLabel": "月付",
    "plans.yearlyLabel": "年付",
    "plans.freePriceLabel": "免费",
    "plans.noCardRequired": "无需银行卡",
    "plans.currentPlanBadge": "当前方案",
    "plans.tier.wayfinder.tagline": "30 天试用 — 开始反思，无需银行卡。",
    "plans.tier.wayfinder.positioning": "开始反思",
    "plans.tier.wayfinder.highlight0": "核心家长反思路径",
    "plans.tier.wayfinder.highlight1": "30 天免卡试用",
    "plans.tier.wayfinder.highlight2": "试用期内无限保存反思",
    "plans.tier.wayfinder.highlight3": "隐私优先 — 无广告、不出售数据",
    "plans.tier.wayfinder_plus.tagline": "解锁无限保存与家长成长进度追踪。",
    "plans.tier.wayfinder_plus.positioning": "追踪您的成长",
    "plans.tier.wayfinder_plus.highlight0": "无限保存反思",
    "plans.tier.wayfinder_plus.highlight1": "家长成长进度追踪",
    "plans.tier.wayfinder_plus.highlight2": "完整反思记录与练习历史",
    "plans.tier.wayfinder_connect.tagline": "增加由家长控制的 MHP 审阅支持。",
    "plans.tier.wayfinder_connect.positioning": "增加 MHP 审阅（家长控制）",
    "plans.tier.wayfinder_connect.highlight0": "包含 Wayfinder Plus 全部内容",
    "plans.tier.wayfinder_connect.highlight1": "仅由家长控制分享 — 不会自动分享",
    "plans.tier.wayfinder_connect.highlight2": "启用后每月含 1 次 MHP 审阅请求",
    "appVersion.title": "版本更新",
    "appVersion.subtitle": "面向家长的 Wayfinder 更新、隐私提醒与计划改进记录。",
    "appVersion.releasedHeading": "近期更新",
    "appVersion.plannedHeading": "计划中",
    "appVersion.reassurance": "这些说明帮助您了解可能的变化与后续计划。它们不是标签、分数或临床评估。",
    "appVersion.workflowNote": "Wayfinder 在发布面向家长的改进时会更新此页。未来研究或数据使用将始终有明确说明、同意与隐私保障。",
    "appVersion.plannedNote": "以下项目仍在计划中，可能随 Wayfinder 发展而调整。",
    ...
    "reviewShare.dashboardCardSubtitle": "选择已保存的日记或解读记录，与您的 MHP 进行有时限的 ALIGN/CAB 审阅。同意前您会预览将分享的内容。",
    "reviewShare.dashboardCardButton": "打开分享",
    "reviewShare.dashboardAction": "分享给 MHP 审阅",
    "reviewShare.browseTrail": "查看完整反思记录",
    "reviewShare.postSaveButton": "分享这份反思给 MHP 审阅",
    "reflection.languageHelper": "你可以用最自然的语言记录。Wayfinder 会保留你的原文，不会自动翻译你的私人反思。",
