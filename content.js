...
const WAYFINDER_PLANS_PAGE = {
  ...
  manageBillingSessionSafetyNote: "For your privacy, Stripe opens in a secure billing page. Please close the Stripe billing tab when finished, especially on a shared device.",
  ...
  billingReturnSessionSafetyNote: "Billing changes are confirmed by Stripe. If you used a shared device, close any Stripe billing tabs.",
...
const MENTAL_HEALTH_PROFESSIONAL_ONBOARDING = {
  ...
  inviteProfileSetupTitle: "Set up your Wayfinder Mental Health Professional profile",
  inviteProfileSetupIntro: "You've been invited to begin Mental Health Professional onboarding with Wayfinder.",
  ...
  inviteCreateAccountTitle: "Create your Wayfinder Mental Health Professional account",
  ...
  inviteAutoAcceptTitle: "Setting up your Mental Health Professional profile…",
  ...
  inviteNoActiveInviteMessage: "No active Mental Health Professional invitation was found for this signed-in email.",
  ...
  mhpSetupSignInGuidance: "Your email is verified. Sign in with the invited email address to continue Mental Health Professional profile setup.",
  ...
  inviteVerificationBody: "Please confirm your email address before continuing Mental Health Professional profile setup. After verification, sign in at the MHP portal and Wayfinder will continue setup using your verified invited email.",
  inviteTitle: "Set up your Wayfinder Mental Health Professional profile",
  inviteSubtitle: "You've been invited to begin Mental Health Professional onboarding with Wayfinder.",
  ...
  inviteAcceptedMessage: "You may begin your Mental Health Professional profile and licence draft. Publication still requires Wayfinder review.",
...
const MENTAL_HEALTH_PROFESSIONAL_INVITE_REQUEST = {
  ...
  modalIntro: "Mental Health Professional accounts are invitation-only. Submit this request for Wayfinder admin review. No account, invite link, or MHP access is created until admin approval.",
