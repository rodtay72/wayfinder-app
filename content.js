...
const PARENT_REVIEW_SHARING = {
  ...
  counsellorSelectLabel: "Choose your counsellor",
  counsellorSelectPlaceholder: "Select a counsellor…",
  counsellorSelectHint: "Only verified Wayfinder counsellors appear here. Your counsellor may share their Wayfinder ID with you if needed.",
  noCounsellorsAvailable: "No counsellors are available for review sharing yet. Please contact your Wayfinder administrator.",
  counsellorRequired: "Please choose a counsellor before sharing.",
...
const MENTAL_HEALTH_PROFESSIONAL_ONBOARDING = {
  ...
  licenseReviewLicenseNumber: "License / registration number",
  ...
  licenseApplyToProfileDraft: "Use these details in my profile draft",
  licenseApplyToProfileDraftSuccess: "Extracted details applied to your profile draft. Please review before saving.",
