...
16. MHP invite acceptance (after PR #132 + SQL apply): invitee opens `/counsellor.html?mhp_invite=<token>`, signs in with invited email, token consumed once, draft MHP profile/onboarding opens; wrong email/expired/consumed token blocked safely.
